...
VK_KHX_external_memory_capabilities = Extension(
    ...
    protos=[
        ...
        Proto("VkResult", "GetPhysicalDeviceImageFormatProperties2KHX",
            [Param("VkPhysicalDevice", "physicalDevice"),
...
VK_NVX_device_generated_commands = Extension(
    ...
    protos=[
        Proto("void", "CmdProcessCommandsNVX",
            [Param("VkCommandBuffer", "commandBuffer"),
             Param("const VkCmdProcessCommandsInfoNVX*", "pProcessCommandsInfo")]),

        Proto("void", "CmdReserveSpaceForCommandsNVX",
            [Param("VkCommandBuffer", "commandBuffer"),
             Param("const VkCmdReserveSpaceForCommandsInfoNVX*", "pReserveSpaceInfo")]),

        Proto("VkResult", "CreateIndirectCommandsLayoutNVX",
            [Param("VkDevice", "device"),
             Param("const VkIndirectCommandsLayoutCreateInfoNVX*", "pCreateInfo"),
             Param("const VkAllocationCallbacks*", "pAllocator"),
        ...
        Proto("VkResult", "CreateObjectTableNVX)",
            [Param("VkDevice", "device"),
             Param("const VkObjectTableCreateInfoNVX*", "pCreateInfo"),
             Param("const VkAllocationCallbacks*", "pAllocator"),
        ...
        Proto("VkResult", "RegisterObjectsNVX",
            [Param("VkDevice", "device"),
             ...
             Param("const VkObjectTableEntryNVX* const*", "ppObjectTableEntries"),
             Param("const uint32_t*", "pObjectIndices")]),

        Proto("VkResult", "UnregisterObjectsNVX)",
            [Param("VkDevice", "device"),
             Param("VkObjectTableNVX", "objectTable"),
             Param("uint32_t", "objectCount"),
             Param("const VkObjectEntryTypeNVX*", "pObjectEntryTypes"),
             Param("const uint32_t*", "pObjectIndices")]),
